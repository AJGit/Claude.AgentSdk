...
public class InvalidConfigurationAnalyzerTests
{
    ...
    {
        return CSharpAnalyzerVerifier<InvalidConfigurationAnalyzer>.VerifyAnalyzerAsync(source, expected);
    }

    private static Task VerifyNoDiagnosticsAsync(string source)
    {
        return CSharpAnalyzerVerifier<InvalidConfigurationAnalyzer>.VerifyNoDiagnosticsAsync(source);
    }

    private static DiagnosticResult MaxTurnsDiagnostic(int value)
    {
        return CSharpAnalyzerVerifier<InvalidConfigurationAnalyzer>
